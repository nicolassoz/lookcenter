...
<div class="container">
    ...
    <div class="checkout-steps">
        ...
        <div class="row">
            <div class="col-md-8">
                <h2 style="color: #ffca28;">Endereço de Entrega</h2>
                <p style="color: white;">informe o endereço onde deseja receber seu pedido.</p>
                ...
                <div class="col-lg-12">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="radioDefault1">
                                            <div class="orders-panel">
                                                ...
                                                <p class="m-0">rua logo ali, 132</p>
                                                <p class="m-0">cep: 11111-111</p>
                                                <p class="m-0">telefone: (11)94002-8922</p>
                                            </div>
                                        </label>
                                    </div>
                    ...
                    <p class="mt-3" style="color: white;">Novo endereço</p> 
                </div>
                
                <form class="orders-panel">
                    <div class="row m-1">
                        ...
                        <div class="col-md-5 mb-3" >
                            ...
                            <input type="text" class="form-control" id="enderecoCad" placeholder="Ex: rua. itaquera">
                        </div>

                        <!-- campo para inserir o numero do endereço -->
                        <div class="col-md-3 mb-3" >
                            <p  style="color: var(--light-gray)">Numero</p>
                            <input type="text" class="form-control" id="numeEnd" placeholder="Ex: 123">
                        </div>
                        ...
                        <div class="justify-content-Center row">
                                ...
                                <a href="#" class="btn btn-outline-warning btn-sm">cadastrar endereço</a>
                                </div>
                        </div>
                    </div>
            ...
            <div class="col-md-5 mt-2">
                <a class="btn" type="button" style="background:trasparet; color:var(--accent-gold); border:1px solid; color: #ffca28;" href="carrinho.php"><i class="bi bi-arrow-left"></i> voltar para o carrinho</a>
            </div>

            <div class="col-md-3 mt-2">
                <a class="btn" type="button" style="background:var(--accent-gold); color:black" href="pagamento.php"> continuar para pagamento <i class="bi bi-arrow-right"></i></a>
            </div>
