...
<div class="container">
    ...
    <div class="row">
        <div class="card col-md-5 m-3">
            ...
            <div id="carouselExample" class="carousel slide">
                <div class="carousel-inner">
                    ...
                    <img src="../../roupas/bermudas/Bermuda_Jeans_Carpenter_Cinza_frente.jpg" class="img-fluid" alt="Bermuda"></div>
                    <div class="carousel-item">
                    <img src="../../roupas/bermudas/Bermuda_Jeans_Carpenter_Cinza_costa.jpg" class="img-fluid" alt="Bermuda">
                    </div>
                </div>
        ...
        <div class="col-md-5 m-3">
            ...
            <h2>Bermuda Tribal Topside</h2>
            <H3 style="color: var(--accent-gold); font-size:45px;">R$130,20</H3>
            <p>ou 3x de 43,40</p>

            <p>Bermuda jeans cinza de modelagem larga estilo streetwear. Traz a escrita gangster "Compton" bordada no bolso traseiro e a logo "C" no bolso lateral.</p>
            <ul>
                <li>???</li>
                <li>???</li>
                <li>???</li>
