...
<div class="container">
    ...
    <div class="row">
        <div class="card col-md-5 m-3">
            <img src="../../roupas/bermudas/Bermuda_Jeans_Topside_cruz.jpg" alt="Bermuda">
        </div>

        <div class="col-md-5 m-3">
            <p style="color: var(--accent-gold);">Bermuda</p>
            <h2>Bermuda jeans topside cruz</h2>
            <H3 style="color: var(--accent-gold); font-size:45px;">R$190,00</H3>
            <p>ou 3x de 63,33</p>

            <p>Bermuda jeans larga grafite com estampa vertical em letras "Topside" na perna esquerda e duas cruzes estilizadas com brilhos/estrelas na perna direita.</p>
            <ul>
                <li>???</li>
                <li>???</li>
                <li>???</li>
