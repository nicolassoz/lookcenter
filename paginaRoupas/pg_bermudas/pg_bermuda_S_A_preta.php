...
<div class="container">
    ...
    <div class="row">
        <div class="card col-md-5 m-3">
             ...
             <div id="carouselExample" class="carousel slide">
                <div class="carousel-inner">
                    ...
                    <img src="../../roupas/bermudas/Bermuda_Streetwear_Preta_Apparel_frente.jpg" class="img-fluid" alt="Bermuda"></div>
                    <div class="carousel-item">
                    <img src="../../roupas/bermudas/Bermuda_Streetwear_Preta_Apparel_costa.jpg" class="img-fluid" alt="Bermuda">
                    </div>
                </div>
        ...
        <div class="col-md-5 m-3">
            <p style="color: var(--accent-gold);">Bermuda</p>
            <h2>Bermuda Cargo Cyber Black</h2>
            <H3 style="color: var(--accent-gold); font-size:45px;">R$110,00</H3>
            <p>ou 3x de 36,66</p>

            <p>Bermuda preta larga de tecido leve com bolso cargo. Destaca-se pelas estampas frontais brancas com traços marcantes e estilo gangster urbano.</p>
            <ul>
                <li>???</li>
                <li>???</li>
                <li>???</li>
