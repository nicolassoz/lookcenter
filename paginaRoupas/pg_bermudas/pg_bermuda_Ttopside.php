...
<div class="container">
    ...
    <div class="row">
        <div class="card col-md-5 m-3">
             ...
             <div id="carouselExample" class="carousel slide">
                <div class="carousel-inner">
                    ...
                    <img src="../../roupas/bermudas/Bermuda_TribalTopside_frente.jpg" class="img-fluid" alt="Bermuda"></div>
                    <div class="carousel-item">
                    <img src="../../roupas/bermudas/Bermuda_TribalTopside_costa.jpg" class="img-fluid" alt="Bermuda">
                    </div>
                </div>
        ...
        <div class="col-md-5 m-3">
            ...
            <h2>bermuda oversized tribal</h2>
            <H3 style="color: var(--accent-gold); font-size:45px;">R$125,30</H3>
            <p>ou 3x de 41,76</p>

            <p>Bermuda cargo preta de estilo oversized com grandes estampas de traços tribais brancos na parte frontal e assinatura discreta no bolso traseiro.</p>
            <ul>
                <li>???</li>
                <li>???</li>
                <li>???</li>
