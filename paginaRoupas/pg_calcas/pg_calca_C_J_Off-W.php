...
<div class="container">
    ...
    <div class="row">
        <div class="card col-md-5 m-3">
            ...
            <div id="carouselExample" class="carousel slide">
                <div class="carousel-inner">
                    ...
                    <img src="../../roupas/calcas/Calça_Cargo_Jeans_Off-White_frente.jpg" class="img-fluid" alt="Calca"></div>
                    <div class="carousel-item">
                    <img src="../../roupas/calcas/Calça_Cargo_Jeans_Off-White_costa.jpg"  class="img-fluid" alt="Calca"></div>
                </div>
        ...
        <div class="col-md-5 m-3">
            ...
            <h2>Calça Jeans Baggy Clássica</h2>
            <H3 style="color: var(--accent-gold); font-size:45px;">R$220,30</H3>
            <p>ou 3x de 73,43</p>
