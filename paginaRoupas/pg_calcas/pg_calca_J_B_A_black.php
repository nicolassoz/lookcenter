        ...
        <div class="card col-md-5 m-3">
            ...
            <div id="carouselExample" class="carousel slide">
                <div class="carousel-inner">
                    ...
                    <img src="../../roupas/calcas/Calça_Jeans_Baggy_Black_Acid_frente.jpg" class="img-fluid" alt="Calca"></div>
                    <div class="carousel-item">
                    <img src="../../roupas/calcas/Calça_Jeans_Baggy_Black_Acid_costa.jpg"  class="img-fluid" alt="Calca"></div>
                </div>
