...
<div class="container">
    ...
    <div class="row">
        <div class="card col-md-5 m-3">
            ...
            <div id="carouselExample" class="carousel slide">
                <div class="carousel-inner">
                    ...
                    <img src="../../roupas/calcas/Calça_Jeans_Baggy_Classic.jpg" class="img-fluid" alt="Calca"></div>
        ...
        <div class="col-md-5 m-3">
            ...
            <h2>Calça Jeans Baggy Classic</h2>
            <H3 style="color: var(--accent-gold); font-size:45px;">R$190,00</H3>
            <p>ou 3x de 63,63</p>

            <p>Calça jeans clássica de caimento bem amplo (skater/baggy) em lavagem azul claro uniforme, sem rasgos ou estampas, focando no caimento do tecido sobre o tênis.</p>
