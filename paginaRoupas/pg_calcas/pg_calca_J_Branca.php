...
<div class="container">
    ...
    <div class="row">
        <div class="card col-md-5 m-3">
            ...
            <div id="carouselExample" class="carousel slide">
                <div class="carousel-inner">
                    ...
                    <img src="../../roupas/calcas/Calça Jeans Branca.jpg" class="img-fluid" alt="Calca"></div>
        ...
        <div class="col-md-5 m-3">
            ...
            <h2>Calça Jeans branca</h2>
            <H3 style="color: var(--accent-gold); font-size:45px;">R$170,00</H3>
            <p>ou 3x de 56,66</p>
