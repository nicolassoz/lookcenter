...
<div class="container">
    ...
    <div class="row">
        <div class="card col-md-5 m-3">
            ...
            <div id="carouselExample" class="carousel slide">
                <div class="carousel-inner">
                    ...
                    <img src="../../roupas/calcas/Calça_Jeans_Carpenter_Light_Blue_frente.jpg" class="img-fluid" alt="Calca"></div>
                    <div class="carousel-item">
                    <img src="../../roupas/calcas/Calça_Jeans_Carpenter_Light_Blue_costa.jpg"  class="img-fluid" alt="Calca"></div>
                </div>
        ...
        <div class="col-md-5 m-3">
            ...
            <h2>Calça Jeans Vintage</h2>
            <H3 style="color: var(--accent-gold); font-size:45px;">R$229,90</H3>
            <p>ou 3x de 76,63</p>

            <p>Calça jeans azul-clara estilo carpinteiro com lavagem vintage, caracterizada pelos painéis duplos de tecido costurados para reforço na parte frontal.</p>
            <ul>
                <li>???</li>
                <li>???</li>
                <li>???</li>
