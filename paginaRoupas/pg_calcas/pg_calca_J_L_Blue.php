...
<div class="container">
    ...
    <div class="row">
        <div class="card col-md-5 m-3">
            ...
            <div id="carouselExample" class="carousel slide">
                <div class="carousel-inner">
                    ...
                    <img src="../../roupas/calcas/Calça Jeans Light Blue.jpg" class="img-fluid" alt="Calca"></div>
        ...
        <div class="col-md-5 m-3">
            ...
            <h2>Calça Jeans Light Blue</h2>
            <H3 style="color: var(--accent-gold); font-size:45px;">R$155,00</H3>
            <p>ou 3x de 51,66</p>

            <p>Calça jeans de modelagem folgada em lavagem clara (light blue), com detalhes de rasgos e puídos na região dos joelhos e coxas.</p>
            <ul>
                <li>???</li>
                <li>???</li>
                <li>???</li>
