...
<div class="container">
    ...
    <div class="row">
        <div class="card col-md-5 m-3">
            ...
            <div id="carouselExample" class="carousel slide">
                <div class="carousel-inner">
                    ...
                    <img src="../../roupas/calcas/Calça_Jeans_Black_Topside_frente.jpg" class="img-fluid" alt="Calca"></div>
                    <div class="carousel-item">
                    <img src="../../roupas/calcas/Calça_Jeans_Black_Topside_costa.jpg"  class="img-fluid" alt="Calca"></div>
                </div>
        ...
        <div class="col-md-5 m-3">
            ...
            <h2>Calça Jeans Tribal</h2>
            <H3 style="color: var(--accent-gold); font-size:45px;">R$200.98</H3>
            <p>ou 3x de 66,99</p>

            <p>Calça jeans larga com lavagem preta estonada, linhas retas clássicas e pequenos detalhes com a tipografia branca da marca perto dos bolsos.</p>
