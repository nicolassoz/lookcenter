...
<div class="container">
    ...
    <div class="row">
        <div class="card col-md-5 m-3">
            ...
            <div id="carouselExample" class="carousel slide">
                <div class="carousel-inner">
                    ...
                    <img src="../../roupas/calcas/Calça_Jeans_Tribal_Blue.jpg" class="img-fluid" alt="Calca"></div>
                    <div class="carousel-item">
                    <img src="../../roupas/calcas/Calça_Jeans_Tribal_Blue_costa.jpg"  class="img-fluid" alt="Calca"></div>
                </div>
        ...
        <div class="col-md-5 m-3">
            ...
            <p>'Calça jeans azul-média com modelagem bem folgada, estampada com uma grande arte tribal em tom azul-claro que percorre toda a lateral da perna.</p>
            <ul>
                <li>???</li>
                <li>???</li>
                <li>???</li>
