...
<div class="container">
    ...
    <div class="row">
        <div class="card col-md-5 m-3">
            ...
            <div id="carouselExample" class="carousel slide">
                <div class="carousel-inner">
                    ...
                    <img src="../../roupas/camisas/camisa_neymar_jr_streetwear_preta_frente.png" class="img-fluid" alt="Camisa">
                    </div>
                    <div class="carousel-item">
                    <img src="../../roupas/camisas/camisa_neymar_jr_treetwear_preta_costa.png" class="img-fluid" alt="Camisa">
                    </div>
                </div>
        ...
        <div class="col-md-5 m-3">
            ...
            <h2>Camisa Neymar Jr.</h2>
            <H3 style="color: var(--accent-gold); font-size:45px;">R$159,99</H3>
            <p>ou 3x de 53,33</p>

            <p>Camisa streerwear preta Neymar jr.</p>
