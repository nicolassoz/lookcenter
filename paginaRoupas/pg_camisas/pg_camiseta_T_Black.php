...
<div class="container">
    ...
    <div class="row">
        <div class="card col-md-5 m-3">
            ...
            <div id="carouselExample" class="carousel slide">
                <div class="carousel-inner">
                    ...
                    <img src="../../roupas/camisas/Camiseta_Topside_black_frente.jpg" class="img-fluid" alt="Camisa">
                    </div>
                    <div class="carousel-item">
                    <img src="../../roupas/camisas/Camiseta_Topside_black_costa.jpg" class="img-fluid" alt="Camisa">
                    </div>
                </div>
        ...
        <div class="col-md-5 m-3">
            ...
            <h2>Camisa Compton Black</h2>
            <H3 style="color: var(--accent-gold); font-size:45px;">R$139,90</H3>
            <p>ou 3x de 46,63</p>

            <p>Camiseta preta com design diferenciado onde a palavra "Com" começa na frente da barra e termina com "pton" cobrindo a parte traseira, em letras góticas brancas gigantes.</p>
