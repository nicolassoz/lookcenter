...
<div class="container">
    ...
    <div class="row">
        <div class="card col-md-5 m-3">
            ...
            <div id="carouselExample" class="carousel slide">
                <div class="carousel-inner">
                    ...
                    <img src="../../roupas/camisas/Camiseta_Tag_Central_frente.jpg" class="img-fluid" alt="Camisa">
                    </div>
                    <div class="carousel-item">
                    <img src="../../roupas/camisas/Camiseta_Tag_Central_costa.jpg" class="img-fluid" alt="Camisa">
                    </div>
                </div>
        ...
        <div class="col-md-5 m-3">
            ...
            <h2>Camisa Graffit black</h2>
            <H3 style="color: var(--accent-gold); font-size:45px;">R$189,90</H3>
            <p>ou 3x de 63,30</p>

            <p>Camiseta preta com pequeno logo centralizado no peito e costas estampadas com caracteres orientais e pichações estilizadas em tinta branca escorrida.</p>
            <ul>
                <li>???</li>
                <li>???</li>
                <li>???</li>
