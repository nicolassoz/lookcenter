        ...
        <div class="card col-md-5 m-3">
            ...
            <div id="carouselExample" class="carousel slide">
                <div class="carousel-inner">
                    ...
                    <img src="../../roupas/camisas/Camiseta_Basic_Tag_Marrom_frente.jpg" class="img-fluid" alt="Camisa">
                    </div>
                    <div class="carousel-item">
                    <img src="../../roupas/camisas/Camiseta_Basic_Tag_Marrom_costa.jpg" class="img-fluid" alt="Camisa">
                    </div>
                </div>
