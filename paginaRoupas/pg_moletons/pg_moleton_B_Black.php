...
<div class="container">
    ...
    <div class="row">
        <div class="card col-md-5 m-3">
            <img src="../../roupas/moletons/Moletom_bear_black_frente.jpg" alt="Moletom">
        </div>

        <div class="col-md-5 m-3">
            <p style="color: var(--accent-gold);">Moletom</p>
            <h2>Moletom Patch Bear black</h2>
            <H3 style="color: var(--accent-gold); font-size:45px;">R$229,00</H3>
            <p>ou 3x de 76,33</p>

            <p>Moletom canguru preto com capuz e cordão de ajuste. Apresenta uma modelagem oversized confortável e um pequeno patch bordado de urso no lado esquerdo do peito.</p>
            <ul>
                <li>???</li>
                <li>???</li>
                <li>???</li>
