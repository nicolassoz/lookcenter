...
<div class="container">
    ...
    <div class="row">
        <div class="card col-md-5 m-3">
            <img src="../../roupas/moletons/Moletom_Graffit_urbano.jpg" alt="Moletom">
        </div>

        <div class="col-md-5 m-3">
            <p style="color: var(--accent-gold);">Moletom</p>
            <h2>Moletom Graffit Urbano</h2>
            <H3 style="color: var(--accent-gold); font-size:45px;">R$250,00</H3>
            <p>ou 3x de 83,33</p>

            <p>Moletom fechado (canguru) preto com uma estampa frontal centralizada em formato de tag de pichação/graffiti na cor branca. Visual de forte inspiração urbana clássica.</p>
            <ul>
                <li>???</li>
                <li>???</li>
                <li>???</li>
