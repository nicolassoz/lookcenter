...
<div class="container">
    ...
    <div class="row">
        <div class="card col-md-5 m-3">
            ...
            <div id="carouselExample" class="carousel slide">
                <div class="carousel-inner">
                    ...
                    <img src="../../roupas/moletons/Moletom_Red_Graphics_frente.jpg" class="img-fluid" alt="Moletom"></div>
                    <div class="carousel-item">
                    <img src="../../roupas/moletons/Moletom_Red_Graphics_costa.jpg"  class="img-fluid" alt="Moletom"></div>
                </div>
        ...
        <div class="col-md-5 m-3">
            ...
            <h2>Moletom White Skull</h2>
            <H3 style="color: var(--accent-gold); font-size:45px;">R$209,00</H3>
            <p>ou 3x de 69,66</p>
