...
<div class="container">
    ...
    <div class="row">
        <div class="card col-md-5 m-3">
            <img src="../../roupas/moletons/Moletom_TPSD_black.jpg" alt="Moletom">
        </div>

        <div class="col-md-5 m-3">
            <p style="color: var(--accent-gold);">Moletom</p>
            <h2>Moletom TPSD black</h2>
            <H3 style="color: var(--accent-gold); font-size:45px;">R$240,00</H3>
            <p>ou 3x de 80,00</p>

            <p>Moletom aberto com zíper (zip-up) preto. Possui o logotipo "TPSD" no peito ladeado por duas grandes estampas simétricas prateadas em estilo tribal futurista.</p>
            <ul>
                <li>???</li>
                <li>???</li>
                <li>???</li>
