...
<!-- pagina que fala sobre a lookcenter -->
...
<!-- texto sobre a lookcenter -->
    <section class="heroN">
        <div class="container">
            ...
            <p class="lead mb-4 text-light">Nós somos a <b>LOKCENTER</b>, uma marca vibrantes que pulsa no ritmo das ruas. Nosso DNA é 100% streetwer criado por e para jovens que não têm medo de ousar e expressar sua identidade única. Acreditamos que a moda é uma ferramenta poderosa de autoexpressão, e por isso, selecionamos curadoria de peças que unem o estilo urbano, o conforto e a atitude.</p>
            ...
            <!-- botão que leva a pagina de roupa -->
